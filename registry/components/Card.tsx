...
export function Card({ title, subtitle, content, footer }: { title?: string, subtitle?: string, content?: unknown[], footer?: unknown[] }) {
  return (
    <div className="h-fit group relative bg-card/60 backdrop-blur-xl border border-black/15 dark:border-border/50 rounded-3xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_15px_40px_rgba(108,87,164,0.1)] hover:-translate-y-1 hover:border-brand/40 transition-all duration-200 ease-out flex flex-col pt-6">
